...
<fieldset id="detailInfo_field">
	...
	<div class="control-group">
		<label class="control-label">操作系统:</label> <select class="span3" name="applicationInfo.OS">
	...
	<div class="control-group">
		...
		<div class="controls">
			<span style="position:relative"><input
				...
				onkeyup='showHint(this.value,arguments[0])' name="applicationInfo.SW" id="soft_input_1"/>&nbsp;&
			<div class="matchSoftwareWindow" id="matchwindow_1">matchWin</div></span>
			<span style="position:relative"><input
				type="text" placeholder="软件名称"
				onkeyup='showHint(this.value,arguments[0])' name="applicationInfo.SW" id="soft_input_2"/>&nbsp;&
			<div class="matchSoftwareWindow" id="matchwindow_2">matchWin</div></span>
			<span style="position:relative"><input
				type="text" placeholder="软件名称"
				onkeyup='showHint(this.value,arguments[0])' name="applicationInfo.SW" id="soft_input_3"/>
