...
public class EApplication  implements java.io.Serializable {
    ...
    /** full constructor */
    public EApplication(String applicationId, String createUser, String approver, String curentHandler, String courseName, String className, Integer seats, String os, String software, Integer booktype, Timestamp createdatetime, String status, Timestamp approvedtime, String approveremark, String comment, String contactNo, String email) {
        this.applicationId = applicationId;
