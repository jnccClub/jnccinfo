...
public class QQClient {
        ...
        private static final String QQ_LOGIN_URL="http://pt.3g.qq.com/psw3gqqLogin";
...
//        }
		...
		public static String login(final String qq, final String password) {
			HashMap<String, String> params = new HashMap<String, String>();
			params.put("login_url", "http://pt.3g.qq.com/s?aid=nLoginnew&q_from=3GQQ");
			params.put("bid_code", "3GQQ");
			params.put("qq", qq);
			params.put("pwd", password);
			params.put("aid", "nLoginHandle");
			params.put("q_from", "");
			params.put("loginType", "1");
			params.put("toQQchat", "true");
			params.put("modifySKey", "0");
        ...
        public static void sendMsg(String toQQ,String msg,String sid){
            ...
            params.put("u", toQQ);
            params.put("do", "send");
            params.put("saveURL", "0");
            params.put("aid", "发送");
            params.put("num", toQQ);
//            params.put("do", "sendsms");
            String test = "test";
            try {
